...
import { Menu, LayoutDashboard, Users, Calendar, Sun, Moon, Settings as SettingsIcon, Apple, BarChart3 } from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/food-database', label: 'Food Database', icon: Apple },
