...
const styles = {
  ...
  meta: { color: 'var(--text-secondary)', fontSize: '0.85rem', margin: '0.2rem 0 0' },
  printBtn: {
  ...
  totalsBox: {
    ...
    padding: '0.75rem 0.9rem', color: 'var(--text-primary)', fontSize: '0.85rem', marginBottom: '1rem',
  },
  mealSection: { background: 'var(--surface)', borderRadius: '10px', padding: '0.85rem 1rem', marginBottom: '0.6rem' },
  mealName: { color: 'var(--success-text)', fontWeight: 600, fontSize: '0.9rem', margin: '0 0 0.5rem' },
  emptyMeal: { color: 'var(--text-muted)', fontSize: '0.8rem', margin: 0 },
  foodRow: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    padding: '0.4rem 0', borderTop: '1px solid var(--border)',
  },
  foodName: { margin: 0, color: 'var(--text-heading)', fontSize: '0.85rem' },
  foodMeasure: { margin: '0.1rem 0 0', color: 'var(--text-secondary)', fontSize: '0.75rem' },
  foodKcal: { margin: 0, color: 'var(--success-text)', fontSize: '0.8rem', fontWeight: 600 },
  notesSection: { background: 'var(--surface)', borderRadius: '10px', padding: '0.85rem 1rem' },
  sectionTitle: {
