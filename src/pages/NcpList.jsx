...
const styles = {
  ...
  card: {
    ...
    background: '#1e293b', borderRadius: '10px', padding: '0.85rem 1rem', textDecoration: 'none', gap: '0.5rem',
  },
  date: { margin: 0, color: '#fff', fontWeight: 600, fontSize: '0.9rem' },
  pes: { margin: '0.3rem 0 0', color: '#94a3b8', fontSize: '0.8rem', lineHeight: 1.4 },
  followUp: { margin: '0.4rem 0 0', color: '#60a5fa', fontSize: '0.75rem' },
  statusBadge: (status) => ({
